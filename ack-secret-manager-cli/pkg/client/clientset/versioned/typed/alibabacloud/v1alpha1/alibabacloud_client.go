...
import (
	...
	"github.com/AliyunContainerService/ack-secret-manager/ack-secret-manager-cli/pkg/client/clientset/versioned/scheme"
...
// NewForConfig creates a new AlibabacloudV1alpha1Client for the given config.
...
// NewForConfigAndClient creates a new AlibabacloudV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*AlibabacloudV1alpha1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
	...
	return &AlibabacloudV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new AlibabacloudV1alpha1Client for the given config and
...
func New(c rest.Interface) *AlibabacloudV1alpha1Client {
	return &AlibabacloudV1alpha1Client{c}
}
